...
moduleRoutes.post('/list', function(req, res)
{
  ...
  if(! validationResponse.success){
    ...
    var query = abstract_db.mysql_select('DISTINCT(Ufind.idU),Ufind.nom,Ufind.tel,Ufind.gps_lat,Ufind.gps_long,Ufind.datetimeMaj, A.etat,A.idU_snd,A.idU_rcv, A.datetimeCrea as date_request, A.datetimeMaj date_response'
